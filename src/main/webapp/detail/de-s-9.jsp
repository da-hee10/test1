...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=s-9";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=s-9">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/s-game9.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               ...
               <div id="write-box-top">            
               	<span style="font-size: 39px;">푸에르토 리코</span>
               </div>
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game1" src="../image/s-game9.png" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game2" src="../image/s9-a.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/s9-b.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/s9-c.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/s9-d.jpg" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
...
src="https://www.youtube.com/embed/KCfUVS8h5TE?si=fsVh0s9t_0Qs0Uzq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>		
		</div>
<!--         <div class="sangse">
