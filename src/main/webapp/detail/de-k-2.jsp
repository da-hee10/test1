...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=k-2";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=k-2">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/k-game2.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               ...
               <div id="write-box-top">            
               	<span style="font-size: 39px;">코코너츠</span>
               </div>
               ...
               <div id="empty-box">
                 ...
                 <table class="table" id="layout-table">
				  <tbody>
				    ...
				    <tr>
				      <th>제조사</th>
				      <td>Maldito Games<br>제작연도 : 2013(년)</td>				      
				  </tbody>
				</table>
				</div>
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game1" src="../image/k-game2.png" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game2" src="../image/k2-a.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/k2-b.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/k2-c.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/k2-d.jpg" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
...
src="https://www.youtube.com/embed/eGcWaU544cE?si=x8rlqb2tMKE3M30n" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>       	
		</div>
        <div class="sangse">
            <img alt="" src="../image/k2-sangse.jpg">
        </div>
        <!-- <div class="sangse">
