...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=f-4";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=f-4">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/f-game4.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               ...
               <div id="write-box-top">            
               	<span style="font-size: 39px;">스페이스 크루</span>
               </div>
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game1" src="../image/f-game4.png" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game2" src="../image/f4-a.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/f4-b.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/f4-c.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/f4-d.jpg" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
 ...
 <div class="container">
  ...
  <div class="tab-content">
    ...
    <div class="bottom">
        ...
        <div class="sangse">
            <img alt="" src="../image/f4-sangse.jpg">
        </div>
    </div>
    <!-- footer start -->
    <div id="footer">
