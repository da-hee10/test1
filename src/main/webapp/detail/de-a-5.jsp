...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=a-5";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=a-5">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/a-game5.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               ...
               <div id="write-box-top">            
               	<span style="font-size: 39px;">인쉬</span>
               </div>
               ...
               <div id="empty-box">
                 ...
                 <table class="table" id="layout-table">
				  <tbody>
				    ...
				    <tr>
				      <th>제조사</th>
				      <td>DiceTree Games<br>제작연도 : 2003(년)</td>				      
				  </tbody>
				</table>
				</div>
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game1" src="../image/a-game5.png" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game2" src="../image/a5-a.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/a5-b.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/a5-c.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/a5-d.jpg" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
  ...
  <div class="tab-content">
    ...
    <div class="bottom">
        <div class="video">
            ...
            src="https://www.youtube.com/embed/BnAKYb6w5jE?si=xxFIveJjmAzNmjOS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
<!--         <div class="sangse">
