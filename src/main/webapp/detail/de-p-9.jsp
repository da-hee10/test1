...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=p-9";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=p-9">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/p-game9.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               <!-- <img alt="" src="image/list2.png"> -->
               	...
               	<a class="btn-0">&ensp;&ensp;BEST&ensp;&ensp;</a>
               	<a class="btn-1">&ensp;추천게임&ensp;</a>
               	
               <div id="write-box-top">            
               	<span style="font-size: 39px;">디크립토</span>
               </div>
               <div id="write-box-middle">
               <div id="empty-box">
               	<span id="event">이 게임과 비슷한 게임&ensp;<a href="category.do?sub_p_category=파티게임&sub_p_page=party">보러가기</a></span>
               </div>
                 <table class="table" id="layout-table">
				  <tbody>
				    ...
				    <tr>
				      <th>제조사</th>
				      <td>ADC Blackfire Entertainment<br>제작연도 : 2018(년)</td>				      
				  </tbody>
				</table>
				</div>
               <div id="write-box-bottom">
               		<img id="write-bottom" src="../image/blue03.jpg">
               </div>
        </div> 
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game1" src="../image/p-game9.png" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game2" src="../image/p9-a.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/p9-b.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/p9-c.jpg" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/p9-d.jpg" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
...
src="https://www.youtube.com/embed/pdGw9iy-9do?si=vE6g3d0mAnQ9W5_G" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>		
		</div>
        <div class="sangse">
            <img alt="" src="../image/p9-sangse.jpg">
        </div> 
        <!-- <div class="sangse">
