...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/detaillogout.do?a_cate=a-2";
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/detaillogin_form.do?a_cate=a-2">로그인</a>
...
<!-- 헤더 메인 메뉴 end -->
    <div class="box">
            ...
            <div class="image-box">
                <div class="image">
                    <img alt="" src="../image/a-game2.png" id="a1">
                </div>
            </div>
        ...
        <div class="write-box">
               ...
               <div id="write-box-top">            
               	<span style="font-size: 39px;">워 체스트</span>
               </div>
        ...
        <div class="small-image-box">
                ...
                <div class="small-image">
                    <img id="game2" src="../image/a2-a.JPG" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game3" src="../image/a2-b.JPG" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game4" src="../image/a2-c.JPG" onmouseover="imgChange(this)">
                </div>
                <div class="small-image">
                    <img id="game5" src="../image/a2-d.JPG" onmouseover="imgChange(this)">
                </div>
                <div></div>
            </div>
 ...
 <div class="container">
  ...
  <div class="tab-content">
    ...
    <div class="bottom">
        <div class="video">
            <iframe width="800" height="420" src="https://www.youtube.com/embed/8gVwDRGkY0Q?si=oNvyxCHRrx6emyF8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div class="sangse">
            <img alt="" src="../image/a2-sangse.jfif">
        </div>
        <!-- <div class="sangse">
