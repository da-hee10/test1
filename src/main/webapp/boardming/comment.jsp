...
<body>
	...
	<div class="c-btn">
      ...
      <!----------------------------------------------------------------------------------->
        ...
        <div class="comments" id="comment_${vo.cmt_idx}" 
				          data-nickname= "${vo.mem_nickname}"
				    	  data-regdate = "${fn:substring(vo.cmt_regdate, 0, 16)}"
				    	  data-memidx  = "${vo.mem_idx}" data-cidx="${commu.c_idx}">
