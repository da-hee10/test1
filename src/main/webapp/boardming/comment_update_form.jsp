...
<title>우리들의 보드게임 세상 보드밍</title>
  <link rel="stylesheet" href="../css/comment_update_form.css">
	...
	<div class="c-btn">
      ...
      <div>
        ...
        <div class="comments">
            ...
            <p class="comment-content">${ vo.cmt_content }</p>
            
        <div class="c-btn">
          <form>
		        <input type="hidden" name="cmt_idx" value="${ commentIdx.cmt_idx }">
   				<input type="button" class="btn btn-insert" value="완료" onclick="comment_update(this.form)">
   		  </form>
