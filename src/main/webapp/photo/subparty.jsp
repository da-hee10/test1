...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/sublogout.do?sub_p_category=파티게임&sub_p_page=party";
...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href = "sort.do?sub_p_category=파티게임&sub_p_page=party&sub_p_sort=sub_p_title";
	}
	
	function sortByPlaytime() {
		
		location.href = "sort.do?sub_p_category=파티게임&sub_p_page=party&sub_p_sort=sub_p_playtime";
	}
	
	function sortByPeople() {
		
		location.href = "sort.do?sub_p_category=파티게임&sub_p_page=party&sub_p_sort=sub_p_max_player";
	}
	
	function sortByAge() {
		
		location.href = "sort.do?sub_p_category=파티게임&sub_p_page=party&sub_p_sort=sub_p_age";
	}
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/sublogin_form.do?sub_p_category=파티게임&sub_p_page=party">로그인</a>
		...
		<div id="photo-box">
			<c:forEach var="vo" items="${ list }">
				<div class="photo" onclick="showPhoto('${ vo.sub_p_idx }');">
					...
					<div class="img-wrapper"><img src="../images/${ vo.sub_p_filename }" class="img-in-container" 
					...
					<div class="title" style="font-size: 23px; text-align: center; margin-bottom:15px; border-bottom: thin;">연령 : ${ vo.sub_p_age }세 이상</div>
