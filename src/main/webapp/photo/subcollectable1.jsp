...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/sublogout.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1";
...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href = "sort.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1&sub_p_sort=sub_p_title";
	}
	
	function sortByPlaytime() {
		
		location.href = "sort.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1&sub_p_sort=sub_p_playtime";
	}
	
	function sortByPeople() {
		
		location.href = "sort.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1&sub_p_sort=sub_p_max_player";
	}
	
	function sortByAge() {
		
		location.href = "sort.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1&sub_p_sort=sub_p_age";
	}
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/sublogin_form.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1">로그인</a>
	...
	<div class="sub-sort">
	   ...
	   <div class="sort2">
		    <select title="" onchange="window.open(value,'_self');">
        		...
        		<option value="category.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable">3개씩 보기</option>
        		<option value="category.do?sub_p_category=컬렉터블 게임&sub_p_page=collectable1">1개씩 보기</option>
    		</select>
	    </div>
	</div>
				...
				<c:forEach var="vo" items="${ list }">
					<div class="photo" onclick="showPhoto('${ vo.sub_p_idx }');">
						...
						<div class="row">
							...
							<div class="col-sm-6 img_content" style=" display: inline-block;">
								
									<div class="title" style="font-size: 30px; font-weight: bold; text-align: center; margin-top:20px; margin-bottom:10px;">
										${ vo.sub_p_title }
									</div>
		...
		<%-- <div id="photo-box">
			<c:forEach var="vo" items="${ list }">
				<div class="photo" onclick="showPhoto('${ vo.sub_p_idx }');">
					...
					<div class="img-wrapper"><img src="../images/${ vo.sub_p_filename }" class="img-in-container" /></div></div>
					
					<div class="title" style="font-size: 30px; font-weight: bold; text-align: center;">${ vo.sub_p_title }</div>
					<div class="title" style="font-size: 23px; text-align: center;">장르 : ${ vo.sub_p_category }</div>
					<div class="title" style="font-size: 23px; text-align: center;">최소인원 : ${ vo.sub_p_min_player }명</div>
					<div class="title" style="font-size: 23px; text-align: center;">최대인원 : ${ vo.sub_p_max_player }명</div>
					<div class="title" style="font-size: 23px; text-align: center;">플레이타임 : ${ vo.sub_p_playtime }분</div>
					<div class="title" style="font-size: 23px; text-align: center; margin-bottom:15px;">연령 : ${ vo.sub_p_age }세 이상</div>
