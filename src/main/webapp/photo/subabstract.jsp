...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href = "sort.do?sub_p_category=추상게임&sub_p_page=abstract&sub_p_sort=sub_p_title";
	}
	
	function sortByPlaytime() {
		
		location.href = "sort.do?sub_p_category=추상게임&sub_p_page=abstract&sub_p_sort=sub_p_playtime";
	}
	
	function sortByPeople() {
		
		location.href = "sort.do?sub_p_category=추상게임&sub_p_page=abstract&sub_p_sort=sub_p_max_player";
	}
	
	function sortByAge() {
		
		location.href = "sort.do?sub_p_category=추상게임&sub_p_page=abstract&sub_p_sort=sub_p_age";
	}
