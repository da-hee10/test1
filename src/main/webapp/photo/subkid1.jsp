...
<script type="text/javascript">
	...
	$(document).on('click', '#logout', function(e) {
	    ...
	    cancelButtonText: '취소'
	      ...
	      .then((result) => {
	      if (result.value) {
	    	  window.location.href = "../member/sublogout.do?sub_p_category=어린이게임&sub_p_page=kid1";
...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href = "sort.do?sub_p_category=어린이게임&sub_p_page=kid1&sub_p_sort=sub_p_title";
	}
	
	function sortByPlaytime() {
		
		location.href = "sort.do?sub_p_category=어린이게임&sub_p_page=kid1&sub_p_sort=sub_p_playtime";
	}
	
	function sortByPeople() {
		
		location.href = "sort.do?sub_p_category=어린이게임&sub_p_page=kid1&sub_p_sort=sub_p_max_player";
	}
	
	function sortByAge() {
		
		location.href = "sort.do?sub_p_category=어린이게임&sub_p_page=kid1&sub_p_sort=sub_p_age";
	}
	    ...
	    <div id="search">
	        ...
	        <div id="login-main">
	            ...
	            <c:if test="${ empty sessionScope.user }">
	                <a href="../member/sublogin_form.do?sub_p_category=어린이게임&sub_p_page=kid1">로그인</a>
	...
	<div class="sub-sort">
	   ...
	   <div class="sort2">
		    <select title="" onchange="window.open(value,'_self');">
        		...
        		<option value="category.do?sub_p_category=어린이게임&sub_p_page=kid1">1개씩 보기</option>
    		</select>
	    </div>
	</div>
