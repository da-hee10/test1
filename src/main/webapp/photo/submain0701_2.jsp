...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href="sortByName.do"; //
	}
	
	function sortByPlaytime() {
		
		location.href="sortByPlaytime.do";
	}
	
	function sortByPeople() {
		
		location.href="sortByPeople.do";
	}
	
	function sortByAge() {
		
		location.href="sortByAge.do";
	}
...
<div id="sub-box">
	...
	<div class="sub-sort">
	   ...
	   <div class="sort2">
		    <select>
		        <option>2개씩 보기</option>
		        <option>3개씩 보기</option>
		    </select>
	    </div>
		...
		<div id="photo-box">
			<c:forEach var="vo" items="${ list }">
				<div class="photo" onclick="showPhoto('${ vo.sub_p_idx }');">
					...
					<div class="title">${ vo.sub_p_title }</div>
					<div class="title">최소인원 : ${ vo.sub_p_min_player }
										최대인원 : ${ vo.sub_p_max_player }</div>
					<div class="title">플레이타임 : ${ vo.sub_p_playtime }</div>
					<div class="title">연령 : ${ vo.sub_p_age }</div>
					<div class="col-sm-2">
