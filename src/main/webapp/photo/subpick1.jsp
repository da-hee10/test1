...
<script type="text/javascript">
	...
	function sortByName() {
		...
		location.href = "sort.do?sub_p_category=추천게임&sub_p_page=pick1&sub_p_sort=sub_p_title";
	}
	
	function sortByPlaytime() {
		
		location.href = "sort.do?sub_p_category=추천게임&sub_p_page=pick1&sub_p_sort=sub_p_playtime";
	}
	
	function sortByPeople() {
		
		location.href = "sort.do?sub_p_category=추천게임&sub_p_page=pick1&sub_p_sort=sub_p_max_player";
	}
	
	function sortByAge() {
		
		location.href = "sort.do?sub_p_category=추천게임&sub_p_page=pick1&sub_p_sort=sub_p_age";
	}
	...
	<div class="sub-sort">
	   ...
	   <div class="sort2">
		    <select title="" onchange="window.open(value,'_self');">
        		...
        		<option value="category.do?sub_p_category=추천게임&sub_p_page=pick">3개씩 보기</option>
        		<option value="category.do?sub_p_category=추천게임&sub_p_page=pick1">1개씩 보기</option>
    		</select>
	    </div>
	</div>
